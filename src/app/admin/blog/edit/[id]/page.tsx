...
import { updateBlogPost, BlogPost } from "@/lib/firestore";
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-extrabold tracking-tight">Edit Artikel</h1>
            <p className="text-foreground/50 text-sm font-mono">ID: {postId}</p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="card p-4 flex items-center gap-3">
          ...
          <span className="text-sm text-foreground/40">
            Status saat ini: {form.status === "published" ? "Sudah dipublikasikan" : form.status === "review" ? "Menunggu Review Superadmin" : "Masih draft"}
          </span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 pt-4">
          ...
          {role === "content_writer" ? (
            ...
            >
              ...
              {saving ? "Menyimpan..." : "Publish / Update"}
            </button>
          )}
        </div>
      </div>
